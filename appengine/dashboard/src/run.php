...
$run = Database::SelectRow('
  SELECT run_id, problem_id, program_name, run_time_limit, run_score, run_score_stdout, run_score_stderr, run_score_queue, run_stderr, run_queue, run_executed, run_modified, run_created
